...
struct DeviceLog
{
    ...
    std::vector<gnss_pos_t> gps1UbxPos;
...
//    std::vector<rmc_t> rmc;
    ...
    std::vector<gnss_pos_t> gps1Pos;
    std::vector<gnss_pos_t> gps2Pos;
    std::vector<gnss_sat_t> gps1Sat;
    std::vector<gnss_sat_t> gps2Sat;
    ...
    std::vector<gnss_vel_t> gps1Vel;
    std::vector<gnss_vel_t> gps2Vel;
    ...
    std::vector<gnss_pos_t> gps1RtkPos;
