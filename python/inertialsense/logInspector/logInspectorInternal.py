...
class logInspectorInternal(LogInspectorWindow):
    ...
    def createListSensors(self):
        ...
        self.addListItem('IMUs Gyro Combined', 'imusPqrCombined')
        self.addListItem('IMUs Accel Combined', 'imusAccCombined')
        super(logInspectorInternal, self).createListSensors()
        self.addListItem('AVT IMU 1 Gyro',  'avtImu1PQR')
        self.addListItem('AVT IMU 1 Accel', 'avtImu1Acc')
        self.addListItem('AVT IMU 2 Gyro',  'avtImu2PQR')
        self.addListItem('AVT IMU 2 Accel', 'avtImu2Acc')
        self.addListItem('AVT IMU 3 Gyro',  'avtImu3PQR')
        self.addListItem('AVT IMU 3 Accel', 'avtImu3Acc')
        self.addListItem('AVT IMU 4 Gyro',  'avtImu4PQR')
        self.addListItem('AVT IMU 4 Accel', 'avtImu4Acc')
        self.addListItem('Allan Var. Gyro', 'allanVariancePQR')
        self.addListItem('Allan Var. Accel', 'allanVarianceAcc')
        self.addListItem('Allan Var. Test1 Gyro', 'allanVariancePQRTest1')
        self.addListItem('Allan Var. Test1 Accel', 'allanVarianceAccTest1')
        self.addListItem('Allan Var. Test2 Gyro', 'allanVariancePQRTest2')
        self.addListItem('Allan Var. Test2 Accel', 'allanVarianceAccTest2')
        self.addListItem('Allan Var. Test3 Gyro', 'allanVariancePQRTest3')
        self.addListItem('Allan Var. Test3 Accel', 'allanVarianceAccTest3')
        self.addListItem('Allan Var. Test4 Gyro', 'allanVariancePQRTest4')
        self.addListItem('Allan Var. Test4 Accel', 'allanVarianceAccTest4')
