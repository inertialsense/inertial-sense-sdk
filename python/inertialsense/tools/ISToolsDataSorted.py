...
class cDevice:
    def __init__(self, index, directory, serialNumber, refIns=None):
        ...
        self.di[12].set('flashCfg', np.dtype([
            ...
            ('ioConfig', u32),
            ('platformConfig', u32),
            ('gnss2AntOffset', (f32, 3)),
            ('zeroVelRotation', (f32, 3)),
            ('zeroVelOffset', (f32, 3)),
            ('gnssTimeUserDelay', f32),
            ('magDeclination', f32),
        ...
        self.di[22].set('gps1RtkPosMisc', np.dtype([
            ...
            ('baseLla', (f64, 3)),
            ('cycleSlipCount', u32),
            ('roverGnssObservationCount', u32),
            ('baseGnssObservationCount', u32),
            ...
            ('roverGnssEphemerisCount', u32),
            ('baseGnssEphemerisCount', u32),
