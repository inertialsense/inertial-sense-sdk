    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'inertial_sense_ros2.msg.SatInfo')
            logger.debug(
...
class SatInfo(metaclass=Metaclass_SatInfo):
    ...
    def __init__(self, **kwargs):
        ...
        self.sat_id = kwargs.get('sat_id', int())
    ...
    def sat_id(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'sat_id' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'sat_id' field must be an unsigned integer in [0, 4294967295]"
        self._sat_id = value
    ...
    def cno(self, value):
        if self._check_fields:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'cno' field must be an unsigned integer in [0, 4294967295]"
        self._cno = value
