...
class Metaclass_DIDINS2(type):
    """Metaclass of message 'DIDINS2'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'inertial_sense_ros2.msg.DIDINS2')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__didins2
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__didins2
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__didins2
            cls._TYPE_SUPPORT = module.type_support_msg__msg__didins2
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__didins2
...
class DIDINS2(metaclass=Metaclass_DIDINS2):
    """Message class 'DIDINS2'."""
    ...
    def __init__(self, **kwargs):
        ...
        if 'qn2b' not in kwargs:
            self.qn2b = numpy.zeros(4, dtype=numpy.float32)
        else:
            self.qn2b = numpy.array(kwargs.get('qn2b'), dtype=numpy.float32)
            assert self.qn2b.shape == (4, )
        ...
        if self._check_fields:
            if isinstance(value, numpy.ndarray):
                assert value.dtype == numpy.float32, \
                    "The 'qn2b' numpy.ndarray() must have the dtype of 'numpy.float32'"
                assert value.size == 4, \
                    "The 'qn2b' numpy.ndarray() must have a size of 4"
                self._qn2b = value
                return
            ...
            assert \
                ...
                "The 'qn2b' field must be a set or sequence with length 4 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._qn2b = numpy.array(value, dtype=numpy.float32)
