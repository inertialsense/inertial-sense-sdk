...
bool inertial_sense_ros2__msg__didins1__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("inertial_sense_ros2.msg._didins1.DIDINS1", full_classname_dest, 40) == 0);
  }
  inertial_sense_ros2__msg__DIDINS1 * ros_message = _ros_message;
  {  // header
  ...
  {  // uvw
    PyObject * field = PyObject_GetAttrString(_pymsg, "uvw");
    if (!field) {
      return false;
    }
    {
  ...
  {  // ned
    PyObject * field = PyObject_GetAttrString(_pymsg, "ned");
    if (!field) {
      return false;
    }
    {
...
{
  /* NOTE(esteve): Call constructor of DIDINS1 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("inertial_sense_ros2.msg._didins1");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DIDINS1");
  ...
  {  // theta
    ...
    float * src = &(ros_message->theta[0]);
    memcpy(dst, src, 3 * sizeof(float));
    Py_DECREF(field);
  }
  {  // uvw
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "uvw");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
  ...
  {  // ned
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "ned");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
