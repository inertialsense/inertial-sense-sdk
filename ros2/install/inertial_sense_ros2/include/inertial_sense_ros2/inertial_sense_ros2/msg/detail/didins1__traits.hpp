...
#ifndef INERTIAL_SENSE_ROS2__MSG__DETAIL__DIDINS1__TRAITS_HPP_
#define INERTIAL_SENSE_ROS2__MSG__DETAIL__DIDINS1__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  // member: ned
  {
    if (msg.ned.size() == 0) {
      ...
      out << "ned: [";
      size_t pending_items = msg.ned.size();
      for (auto item : msg.ned) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
...
inline std::string to_yaml(const DIDINS1 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const inertial_sense_ros2::msg::DIDINS1 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const inertial_sense_ros2::msg::DIDINS1 & msg)
{
  return inertial_sense_ros2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<inertial_sense_ros2::msg::DIDINS1>()
{
  return "inertial_sense_ros2::msg::DIDINS1";
}

template<>
inline const char * name<inertial_sense_ros2::msg::DIDINS1>()
{
  return "inertial_sense_ros2/msg/DIDINS1";
}

template<>
struct has_fixed_size<inertial_sense_ros2::msg::DIDINS1>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<inertial_sense_ros2::msg::DIDINS1>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<inertial_sense_ros2::msg::DIDINS1>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // INERTIAL_SENSE_ROS2__MSG__DETAIL__DIDINS1__TRAITS_HPP_
