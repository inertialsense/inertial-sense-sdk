...
void serial_port_bridge_forward_unidirectional(pfnIsCommPortRead portRead, pfnIsCommPortWrite portWrite, is_comm_instance_t &comm, uint8_t &serialPortBridge, unsigned int srcPort, unsigned int dstPort, uint32_t led=0, int testMode=1);
#endif
