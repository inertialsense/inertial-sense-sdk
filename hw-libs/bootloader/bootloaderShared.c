...
// We want each board to have their own g_bootloaderRequiredSignature
uint8_t bootloaderRequiredSignature_EVB_2[BOOTLOADER_SIGNATURE_SIZE] =  			
	{ 0x45, 0x0F, 0xF9, 0xA7, 0x17, 0x7D, 0x4E, 0x99, 0xDB, 0x53, 0xA2, 0x72, 0xE7, 0xC3, 0xE1, 0x51 };
uint8_t bootloaderRequiredSignature_uINS_3[BOOTLOADER_SIGNATURE_SIZE] = 
	{ 0x96, 0x0F, 0xF9, 0xA7, 0x17, 0x7D, 0x4E, 0x99, 0xDB, 0x53, 0xA2, 0x72, 0xE7, 0xC3, 0xE1, 0xE5 };
uint8_t bootloaderRequiredSignature_SAMx70_bootloader[BOOTLOADER_SIGNATURE_SIZE] = 
