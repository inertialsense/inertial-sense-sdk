...
#define NUMSATSOL   21      // Max number of observations used in the solution
...
#define EPHEMERIS_ARRAY_BUFFER_MULTIPLIER 1 // can set to 2 to double buffer ephemeris, but this hasn't shown any benefits so far
#define GPS_EPHEMERIS_ARRAY_SIZE ((NSATGPS + NSATGAL + NSATQZS + NSATCMP) * EPHEMERIS_ARRAY_BUFFER_MULTIPLIER)
#define GLONASS_EPHEMERIS_ARRAY_SIZE (NSATGLO * EPHEMERIS_ARRAY_BUFFER_MULTIPLIER)
