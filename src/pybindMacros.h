...
PYBIND11_NUMPY_DTYPE(evb_luna_wheel_controller_t, timeMs, dt, mode, status, velCmd_l, velCmd_r, velCmdSlew_l, velCmdSlew_r, vel_l, vel_r, velErr_l, velErr_r, ff_eff_l, ff_eff_r, fb_eff_l, fb_eff_r, eff_l, eff_r, effLin_l, effLin_r, effOut_l, effOut_r);
