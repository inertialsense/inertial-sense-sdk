...
PYBIND11_NUMPY_DTYPE(rtos_task_t, name, priority, stackUnused, periodMs, runtimeUs, maxRuntimeUs, avgRuntimeUs, lowerRuntimeUs, upperRuntimeUs, gapCount, cpuUsage, handle, startTimeUs);
