...
void imxPlatformConfigToRug3FlashCfgIoConfig(uint32_t *ioConfig, uint32_t platformConfig)
{
    ...
    *ioConfig &= ~IO_CONFIG_G1G2_MASK;
    ...
    case PLATFORM_CFG_RUG3_PRESET__2__S0_TTL_7_9_____CAN_11_12______S1_GPS1:
    case PLATFORM_CFG_RUG3_PRESET__3__S0_TTL_7_9_____S2_TTL_8_10____S1_GPS1:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER1);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
        break;
    case PLATFORM_CFG_RUG3_PRESET__4__S0_RS232_7_9___S1_RS232_8_10__S2_GPS1:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER2);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
        break;
    ...
    case PLATFORM_CFG_RUG3_PRESET__7__S1_RS232_8_10_________________S2_GPS1__S0_GPS2:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER2);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER0);
        break;
    case PLATFORM_CFG_RUG3_PRESET__8_________________CAN_11_12______S1_GPS1__S0_GPS2:
    case PLATFORM_CFG_RUG3_PRESET__9__S2_TTL_8_10___________________S1_GPS1__S0_GPS2:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER1);
    ...
    if (type == PLATFORM_CFG_TYPE_RUG3_G0)
    {
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
    }
    ...
    // GPS type: ZED-F9P
    SET_IO_CFG_GNSS1_TYPE(*ioConfig, IO_CONFIG_GPS_TYPE_UBX_F9P);
    SET_IO_CFG_GNSS2_TYPE(*ioConfig, IO_CONFIG_GPS_TYPE_UBX_F9P);
}
...
void imxPlatformConfigToFlashCfgIoConfig(uint32_t *ioConfig, uint8_t *ioConfig2, uint32_t platformConfig)
{
    ...
    case PLATFORM_CFG_TYPE_NONE:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
        SET_IO_CFG_GNSS1_TYPE(  *ioConfig, IO_CONFIG_GPS_TYPE_NONE);
        SET_IO_CFG_GNSS2_TYPE(  *ioConfig, IO_CONFIG_GPS_TYPE_NONE);
        break;
    case PLATFORM_CFG_TYPE_EVB2_G2:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER1);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER2);
        SET_IO_CFG_GNSS1_TYPE(  *ioConfig, IO_CONFIG_GPS_TYPE_UBX_F9P);
        SET_IO_CFG_GNSS2_TYPE(  *ioConfig, IO_CONFIG_GPS_TYPE_UBX_F9P);
        break;
    ...
    case PLATFORM_CFG_TYPE_IG1_G1:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER0);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_DISABLE);
        SET_IO_CFG_GNSS1_TYPE(*ioConfig, IO_CONFIG_GPS_TYPE_UBX_F9P);
        SET_IO_CFG_GNSS2_TYPE(*ioConfig, IO_CONFIG_GPS_TYPE_UBX_F9P);
        break;
    ...
    case PLATFORM_CFG_TYPE_TBED3_3:
        SET_IO_CFG_GNSS1_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER0);
        SET_IO_CFG_GNSS2_SOURCE(*ioConfig, IO_CONFIG_GPS_SOURCE_SER0);
        SET_IO_CFG_GNSS1_TYPE(*ioConfig, IO_CONFIG_GPS_TYPE_GPX);
        SET_IO_CFG_GNSS2_TYPE(*ioConfig, IO_CONFIG_GPS_TYPE_GPX);
        break;
