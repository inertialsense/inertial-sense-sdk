/**
 * @file MyCustomSerialPortFactory.cpp
 * @brief ${BRIEF_DESC}
 * 
 ...
 */
#include "MyCustomSerialPortFactory.h"
 ...
 * 
 */
port_handle_t MyCustomSerialPortFactory::bindPort(const std::string& pName, uint16_t pType) {
    ...
    *serialPort = {};
    ...
    // serialPort->base.portOpen = MyCustomSerialPortFactory::open_port;
    serialPort->base.portValidate = MyCustomSerialPortFactory::validate_port;
    serialPort->pfnError = MyCustomSerialPortFactory::onPortError;
 ...
 * 
 */
bool MyCustomSerialPortFactory::releasePort(port_handle_t port) {
    if (!port)
        return false;
 ...
 * 
 */
bool MyCustomSerialPortFactory::validatePort(const std::string& pName, uint16_t pType) {
 ...
 * 
 */
void MyCustomSerialPortFactory::locatePorts(std::function<void(PortFactory*, uint16_t, std::string)> portCallback, const std::string& pattern, uint16_t pType) {
...
int MyCustomSerialPortFactory::onPortError(port_handle_t port, int errCode, const char *errMsg) {
 ...
 */
int MyCustomSerialPortFactory::getComPorts(std::vector<std::string>& portNames)
{
    portNames.clear();
 ...
 * @return
 */
bool MyCustomSerialPortFactory::validate_port__linux(uint16_t pType, const std::string& pName) {
    struct stat st;
    char buffer[1024];
...
std::string MyCustomSerialPortFactory::get_driver__linux(const std::string& tty)
{
    struct stat st;
...
void MyCustomSerialPortFactory::register_comport__linux(std::vector<std::string>& comList, std::vector<std::string>& comList8250, const std::string& dir)
{
...
void MyCustomSerialPortFactory::probe_serial8250_comports__linux(std::vector<std::string>& comList, std::vector<std::string> comList8250)
{
