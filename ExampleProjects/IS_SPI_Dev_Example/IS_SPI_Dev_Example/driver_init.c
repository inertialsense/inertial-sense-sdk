...
void system_init(void)
{
	...
	// Set pin direction to input
	gpio_set_pin_direction(MODE_SELECT, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(MODE_SELECT,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	// Set pin direction to input
	gpio_set_pin_direction(DATA_READY, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(DATA_READY,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
